...
function PlaquetaBuilderContent() {
  ...
  const [elements, setElements] = useState<CanvasElement[]>([
    { id: "text-1", type: "text", text: "RECONOCIMIENTO", x: 25, y: 15, width: 250, height: 30, zIndex: 2, fontSize: 24, isCurved: false, fontFamily: 'serif', fontStyle: 'Bold', color: '#000000' },
    { id: "text-2", type: "text", text: "AL MÉRITO", x: 25, y: 45, width: 250, height: 30, zIndex: 3, fontSize: 18, isCurved: false, fontFamily: 'serif', fontStyle: 'Normal', color: '#000000' },
    { id: "text-3", type: "text", text: "Por su inquebrantable dedicación, liderazgo excepcional y contribuciones invaluables que han dejado una huella imborrable en nuestra organización.", x: 20, y: 85, width: 260, height: 95, zIndex: 4, fontSize: 13, isCurved: false, fontFamily: 'serif', fontStyle: 'Italic', color: '#000000' },
    { id: "text-4", type: "text", text: "2026", x: 50, y: 185, width: 200, height: 30, zIndex: 5, fontSize: 16, isCurved: false, fontFamily: 'serif', fontStyle: 'Bold', color: '#000000' },
  ...
  const StaticPlaqueta = ({ line1, line2, line3, line4 }: { line1: string, line2: string, line3: string, line4: string }) => {
    ...
    if (textElements.length === 1) {
      ...
      computedElements = computedElements.map(el => 
        el.id === textEl.id 
        ? { ...el, y: 375 / 2 - (newHeight / 2), height: newHeight, fontSize: (el.fontSize || 24) * 1.5, width: 260, x: 20 } 
        : el
      );
    }
          ...
          <div className="bg-white dark:bg-[#111] rounded-3xl border border-gray-200 dark:border-gray-800 p-8 shadow-xl">
            <div className="flex justify-between items-start mb-6 border-b border-gray-100 dark:border-gray-800 pb-4">
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Crea la plantilla base. Luego, aplicarás los textos masivamente. Puedes mover y redimensionar los elementos libremente.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex justify-center items-center relative">
                <img src="/categorias/plaqueta.png" className="absolute inset-0 w-full h-full object-contain opacity-20 pointer-events-none" alt="" />
                <div className="w-[300px] h-[375px] border border-yellow-600 shadow-[inset_0_0_10px_rgba(0,0,0,0.5),0_10px_30px_rgba(0,0,0,0.2)] overflow-hidden relative bg-gradient-to-br from-[#bf953f] via-[#fcf6ba] to-[#b38728] z-10">
                  <CanvasEditor 
                    elements={elements} 
          ...
          <div className="bg-white dark:bg-[#111] rounded-3xl border border-gray-200 dark:border-gray-800 p-8 shadow-xl">
            ...
            {personalizationType === "NONE" && (
              <div className="p-10 text-center bg-gray-50 dark:bg-[#1a1a1a] rounded-xl border border-gray-200 dark:border-gray-800">
                <p className="text-sm text-gray-500">Se enviarán las plaquetas con la lámina en blanco para tu propia personalización.</p>
              </div>
            )}
                  ...
                  <div key={row.id} className={`grid grid-cols-1 xl:grid-cols-2 gap-8 items-center bg-gray-50 dark:bg-[#1a1a1a] p-8 rounded-xl border transition-colors ${previewRowId === row.id ? 'border-[#d32f2f] shadow-md' : 'border-gray-200 dark:border-gray-800'}`}>
                    <div className="flex flex-col gap-4">
                      <div className="flex justify-between items-center mb-2">
                         <h4 className="text-sm font-black uppercase text-[#d32f2f]">Plaqueta {idx + 1}</h4>
        ...
        <div className="w-full lg:col-span-1">
          <div className="bg-white dark:bg-[#111] p-10 rounded-3xl border border-gray-200 dark:border-gray-800 sticky top-24 shadow-2xl flex flex-col gap-6">
             ...
             <div className="relative h-64 w-full flex items-center justify-center bg-gray-50 dark:bg-[#1a1a1a] rounded-xl border border-gray-200 dark:border-gray-800 p-4">
                <img src="/categorias/plaqueta.png" className="h-full w-auto object-contain drop-shadow-2xl hover:scale-105 transition-transform" alt="Plaqueta" />
             </div>
             ...
             <div className="flex flex-col gap-5 border-t border-gray-100 dark:border-gray-800 pt-6">
                <div>
                  ...
                  <div className="w-full bg-gray-50 dark:bg-[#1a1a1a] border border-gray-300 dark:border-gray-700 rounded-lg p-4 font-bold text-base">Plaqueta Premium MDF</div>
                </div>
                <div>
